...
`.env` files are already in the repo. If missing, copy from `.env.example`.
...
git pull origin main
git add README.md
git commit -m "docs: add README with setup and branch workflow"
git push origin main
```

Share the repo link with your team. Done.
